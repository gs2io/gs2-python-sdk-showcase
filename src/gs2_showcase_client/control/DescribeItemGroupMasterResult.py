...
class DescribeItemGroupMasterResult(object):
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(DescribeItemGroupMasterResult, self).__getitem__(key)
