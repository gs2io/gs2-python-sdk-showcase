...
class DescribeShowcaseItemMasterRequest(Gs2BasicRequest):

    class Constant(Gs2Showcase):
        FUNCTION = "DescribeShowcaseItemMaster"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeShowcaseItemMasterRequest, self).__init__(params)
        if params is None:
    ...
    def with_showcase_name(self, showcase_name):
        ...
        :type showcase_name: unicode
        :return: this
        :rtype: DescribeShowcaseItemMasterRequest
        """
