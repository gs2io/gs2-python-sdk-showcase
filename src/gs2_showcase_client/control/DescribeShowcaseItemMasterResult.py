...
class DescribeShowcaseItemMasterResult(object):
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(DescribeShowcaseItemMasterResult, self).__getitem__(key)
