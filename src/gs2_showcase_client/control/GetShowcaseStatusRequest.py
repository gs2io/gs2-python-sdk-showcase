...
class GetShowcaseStatusRequest(Gs2BasicRequest):

    class Constant(Gs2Showcase):
        FUNCTION = "GetShowcaseStatus"
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetShowcaseStatusRequest, self).__init__(params)
        if params is None:
    ...
    def with_showcase_name(self, showcase_name):
        ...
        :type showcase_name: unicode
        :return: this
        :rtype: GetShowcaseStatusRequest
        """
